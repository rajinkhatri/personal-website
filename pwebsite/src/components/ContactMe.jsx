...
const ContactMe = () => {
  ...
  <div className='bg-zinc-300'>
    <div>
    <p className=' text-black font-thin pt-4 italic'>The above section is just beautiful but doesn't work.</p>
    <a href="mailto: khatrirajin64@gmail.com" className='text-black font-sem text-2xl'><img src="" alt="" />Mail me</a>
    </div>
  </div>
  )
}
