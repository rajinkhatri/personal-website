    ...
    <div className='mx-auto my-0 bg-zinc-200'>
      <div className=' flex flex-col md:flex-row-reverse w-4/5 mx-auto my-0'>
        ...
        <div className='w-3/4 sm:w-full mx-auto my-0 '>
          <p className='text-zinc-800 m-4 pt-8 pb-8 lg:text-6xl sm:text-3xl sm:text-center max-[660px]:text-3xl font-bold md:p-8 md:mt-20 md:mb-4 w-11/12 md:mx-auto '>Front-End React Developer 👋</p>
          ...
          <div className='flex flex-row w-full justify-start md:my-2 lg:my-8 mx-auto gap-4 p-8'>
